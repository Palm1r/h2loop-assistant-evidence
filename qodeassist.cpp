        ...
        quickRefactorAction.addOnTriggered(this, [this] {
            if (auto editor = TextEditor::TextEditorWidget::currentTextEditorWidget()) {
                if (m_qodeAssistClient && m_qodeAssistClient->reachable()) {
                    ...
                    InlineRefactorWidget *widget = new InlineRefactorWidget(editor, m_lastRefactorInstructions);
                    ...
                    connect(widget, &InlineRefactorWidget::rejected, widget, &InlineRefactorWidget::deleteLater);
